...
`ghcr.io/the-cybersapien/lumberroom-server:0.2.0` and falls back to building from this tree when the
...
```bash
tag=v0.2.0; target=aarch64-apple-darwin      # or x86_64-apple-darwin,
...
```bash
sudo dpkg -i lumberroom_0.2.0-1_amd64.deb     # or lumberroom_0.2.0-1_arm64.deb
sudo rpm -i lumberroom-0.2.0-1.x86_64.rpm     # or lumberroom-0.2.0-1.aarch64.rpm
```
